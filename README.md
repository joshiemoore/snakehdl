...
![](HACK_ALU.png)
*Part of the HACK ALU from* [Elements of Computing Systems](https://www.nand2tetris.org/book) *implemented in snakeHDL and imported to Logisim. See* [HACK_ALU.py](https://github.com/joshiemoore/snakehdl/blob/master/examples/HACK_ALU.py)
